%b. a quantidade de neurônios em cada camada escondida

rng(pi);
[X,T] = prprob;

scenarios = {};
scenarios{1}.hiddenLayers = [25];
scenarios{2}.hiddenLayers = [75];
scenarios{3}.hiddenLayers = [200];
scenarios{4}.hiddenLayers = [400];
...
for index = 1:length(scenarios)
    ...
    saveas(fig, sprintf("plots/neurons%d.png", index));
end