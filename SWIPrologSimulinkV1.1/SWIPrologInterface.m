function [sys,x0,str,ts] =SWIPrologInterface(t,x,u,flag,jarFile,plFile,nIn,plQuery,nOut,ClauseResult)
...
if (length(cell2mat(strfind(lower(javaclasspath),'jpl.jar'))) == 0)
    javaaddpath(jarFile);
end
